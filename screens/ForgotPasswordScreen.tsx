...
import { useForgotPassword, useVerifyPhoneNumber } from '../hooks/authenticationHook';
...
export default function ForgotPassworSreen() {
                            ...
                            <View className="flex items-center mx-5 space-y-4">
                                {
                                    checkOtp
                                        ...
                                        isVeriry
                                            ?
                                            <SetNewPassword email={watch('email')}></SetNewPassword>
                                            :
                                            <>
                                                <Animated.View
